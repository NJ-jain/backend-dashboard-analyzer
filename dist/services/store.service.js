...
exports.latestDashboardData = exports.sseClients = void 0;
...
const broadcast_service_js_1 = require("./broadcast.service.js");
// Global active SSE clients registry
exports.sseClients = new Set();
// Global latest EHS Dashboard data cache
exports.latestDashboardData = null;
/**
 * Register a new SSE client
 */
function addSSEClient(client) {
    exports.sseClients.add(client);
    console.log(`[Store] SSE Client registered: ${client.id}. Total active: ${exports.sseClients.size}`);
}
/**
...
function removeSSEClient(clientId) {
    ...
    if (found) {
        exports.sseClients.delete(found);
        console.log(`[Store] SSE Client pruned: ${clientId}. Total active: ${exports.sseClients.size}`);
    }
}
...
function updateDashboardData(newData) {
    const current = exports.latestDashboardData || getInitialMockData();
    exports.latestDashboardData = {
        ...current,
        ...newData,
    ...
    broadcastDebounceTimer = setTimeout(() => {
        ...
        if (exports.latestDashboardData) {
            (0, broadcast_service_js_1.broadcast)("dashboard_update", exports.latestDashboardData);
        }
    }, 500);
    return exports.latestDashboardData;
}
/**
...
exports.latestDashboardData = getInitialMockData();
